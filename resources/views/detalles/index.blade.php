...
<div class="wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                ...
                <div class="col-sm-6">
                    ...
                    <li class="breadcrumb-item active">Detalles de Mantenimiento</li>
                    </ol>
                </div>
                </div>
            </div>
            ...
            <div class="card-body">
               ...
               <table class="table table-striped my-4 w-100" id="datatable2">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td class="gradeX">{{ $detalle->mantenimiento }}</td>
                        <td class="gradeX">{{ $detalle->id }}</td>
                        <td class="gradeX">{{ $detalle->estado }}</td>
                        <td class="gradeX">{{ $detalle->descripcion }}</td>
                        <td class="gradeX">{{ $detalle->fecha }}</td>
    ...
    @section('contentFooter')
        ...
        <div class="row align-items-center">
            <div class="col-12">
                Contador de Visitas Detalles Show: {{$visit}}
            </div>
        </div>
    @endsection
