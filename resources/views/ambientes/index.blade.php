...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="card">
            ...
            <div class="card-body">
                @can('crear-ambiente')
                    <a class="btn btn-warning" href="{{ route('ambientes.create') }}">Nuevo</a>
                @endcan
                <br>
                &nbsp
               <table class="table table-striped my-4 w-100" id="datatable2">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td class="gradeX">{{ $ambiente->id }}</td>
                        <td class="gradeX">{{ $ambiente->nombre }}</td>
                        <td class="gradeX">{{ $ambiente->tipo }}</td>
                        <td class="gradeX">{{ $ambiente->descripcion }}</td>
                        <td class="gradeX">{{ $ambiente->dimension }}</td>
                        <td class="gradeX">{{ $ambiente->ubicacion }}</td>
                        <td class="gradeX">{{ $ambiente->foto }}</td>
                        <td>
                            <form action="{{ route('ambientes.destroy',$ambiente->id) }}" method="POST">
                                @can('editar-ambiente')
                                <a class="btn btn-info" href="{{ route('ambientes.edit',$ambiente->id) }}">Editar</a>
                                @endcan
    ...
    @section('contentFooter')
        ...
        <div class="row align-items-center">
            <div class="col-12">
                Contador de Visitas Ambientes Show: {{$visit}}
            </div>
        </div>
    @endsection
