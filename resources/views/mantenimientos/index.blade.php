...
<div class="wrapper">
        ...
        <div class="card">
            ...
            <div class="card-body">
                @can('crear-mantenimiento')
                    <a class="btn btn-warning" href="{{ route('mantenimientos.create') }}">Nuevo</a>
                @endcan
                <br>
                &nbsp
               <table class="table table-striped my-4 w-100" id="datatable2">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td class="gradeX">{{ $mantenimiento->id }}</td>
                        <td class="gradeX">{{ $mantenimiento->tipo }}</td>
                        <td class="gradeX">{{ $mantenimiento->fecha_solicitud }}</td>
                        <td class="gradeX">{{ $mantenimiento->descripcion }}</td>
                        <td class="gradeX">{{ $mantenimiento->activo }}</td>
                        <td class="gradeX">{{ $mantenimiento->responsable }}</td>
                        <td>
                            <form action="{{ route('mantenimientos.destroy',$mantenimiento->id) }}" method="POST">
                                @can('editar-mantenimiento')
                                <a class="btn btn-info" href="{{ route('mantenimientos.edit',$mantenimiento->id) }}">Editar</a>
                                @endcan
    ...
    @section('contentFooter')
        ...
        <div class="row align-items-center">
            <div class="col-12">
                Contador de Visitas Mantenimientos Show: {{$visit}}
            </div>
        </div>
    @endsection
