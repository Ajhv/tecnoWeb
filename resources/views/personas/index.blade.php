...
<div class="wrapper">
            ...
            <div class="card-body">
               ...
               <table class="table table-striped my-4 w-100" id="datatable2">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td class="gradeX">{{ $persona->id }}</td>
                        <td class="gradeX">{{ $persona->nombre }}</td>
                        <td class="gradeX">{{ $persona->ci }}</td>
                        <td class="gradeX">{{ $persona->ambiente }}</td>
                        <td>
    ...
    @section('contentFooter')
        ...
        <div class="row align-items-center">
            <div class="col-12">
                Contador de Visitas Personas Show: {{$visit}}
            </div>
        </div>
    @endsection
