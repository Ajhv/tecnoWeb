...
<div class="wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                ...
                <div class="col-sm-6">
                    ...
                    <li class="breadcrumb-item active">Movimiento de Activos</li>
                    </ol>
                </div>
                </div>
            </div>
            ...
            <div class="card-body">
               ...
               <table class="table table-striped my-4 w-100" id="datatable2">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td class="gradeX">{{ $movimiento->id }}</td>
                        <td class="gradeX">{{ $movimiento->tipo }}</td>
                        <td class="gradeX">{{ $movimiento->activo }}</td>
                        <td class="gradeX">{{ $movimiento->fecha_movimiento }}</td>
                        <td class="gradeX">{{ $movimiento->ambiente_origen }}</td>
                        <td class="gradeX">{{ $movimiento->ambiente_destino }}</td>
                        <td class="gradeX">{{ $movimiento->responsable }}</td>
                        <td class="gradeX">{{ $movimiento->descripcion }}</td>
                        <td>
    ...
    @section('contentFooter')
        ...
        <div class="row align-items-center">
            <div class="col-12">
                Contador de Visitas Movimientos Show: {{$visit}}
            </div>
        </div>
    @endsection
