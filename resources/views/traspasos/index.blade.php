...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Asignacion de Activos</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                    <li class="breadcrumb-item active">Asignacion de activos</li>
                    </ol>
                </div>
                </div>
            </div>
            ...
            <div class="card-body">
               ...
               <table class="table table-striped my-4 w-100" id="datatable2">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td class="gradeX">{{ $traspaso->id }}</td>
                        <td class="gradeX">{{ $traspaso->fecha_asignacion }}</td>
                        <td class="gradeX">{{ $traspaso->activo }}</td>
                        <td class="gradeX">{{ $traspaso->encargado }}</td>
                        <td class="gradeX">{{ $traspaso->ambiente }}</td>
                        <td>
    ...
    @section('contentFooter')
        ...
        <div class="row align-items-center">
            <div class="col-12">
                Contador de Visitas Traspasos Show: {{$visit}}
            </div>
        </div>
    @endsection
